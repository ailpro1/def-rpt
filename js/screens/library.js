  ...
  function paint() {
    ...
    if (tab === 'captions') {
      ...
      body.appendChild(ui.h('div', { class: 'hint',
        text: 'Both report formats group a section\u2019s photos by component, each under its own numbered heading. '
          + 'The defect-table format also prints one table per group.' }));
